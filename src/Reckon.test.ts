...
test('reckon: overflow calculation fixed.', () => {
  const records = [
  ...
  const ledgers = reckon(balances, [])

  const expected = [
    { "debtor": { "id": 3, "name": "Tom" }, "amount": 27200392.6, "creditor": { "id": 1, "name": "AnuchitO" } },
    { "debtor": { "id": 5, "name": "Pan" }, "amount": 27200392.6, "creditor": { "id": 1, "name": "AnuchitO" } },
    { "debtor": { "id": 2, "name": "Kob" }, "amount": 27077269.6, "creditor": { "id": 1, "name": "AnuchitO" } },
    { "debtor": { "id": 4, "name": "Sao" }, "amount": 14580111.6, "creditor": { "id": 1, "name": "AnuchitO" } }
  ]
  expect(ledgers).toEqual(expected)
